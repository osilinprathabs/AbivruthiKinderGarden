            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="contact_form form_style" >
                        <h2 class="kid_title mb-4">We`re here to Help You</h2>
                        <form id="contactForm">
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="form_single_item">
                                        <input type="phone" name="#" placeholder="Your Phone" id="number">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form_single_item">
                                ...
                                <div class="col-lg-12">
                                    <div class="form_single_item">
                                        <textarea name="#" placeholder="Message" id="message"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button class=" pc-button elementor-button button-link cu_btn button-content-wrapper" id="submit-btn" type="submit">
                                Submit
                            </button>
                        </form>
                    </div>
                ...
                <div class="col-lg-4 pl-lg-5">
                    <div class="blog_sidebar">
                        <div class="contact_sidebar">
                            <h2 class="kid_title mb-4">Office Info</h2>
                            ...
                            <div class="single_contact_sidebar">
                                ...
                                <div class="contact_sidevar_content">
                                    <h5>Phone</h5>
                                    <a href="+919047676525"><p>+919047676525</p></a>
                                </div>
                            </div>
                            <div class="single_contact_sidebar">
                                <i class="icon_mail"></i>
                                <div class="contact_sidevar_content">
                                    <h5>Email</h5>
                                    <a href="mailto:info.abivruthi@gmail.com">
                                    <p>info.abivruthi@gmail.com</p>
                                </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 p-0">
                    <div class="contactMap">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5566.007783577465!2d79.13660050626791!3d12.952051378028148!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bad47646f906ad3%3A0xd61cc0278f0a7528!2s21%2C%2011th%20East%20Cross%20Rd%2C%20Suthanthira%20Ponvizha%20Nagar%2C%20Gandhi%20Nagar%2C%20Vellore%2C%20Tamil%20Nadu%20632006!5e0!3m2!1sen!2sin!4v1716282965967!5m2!1sen!2sin" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
